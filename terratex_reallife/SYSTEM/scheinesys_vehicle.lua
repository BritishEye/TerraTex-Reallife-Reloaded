        ...
        if not (isNoLicensCar(vehid)) then
            ...
            elseif (isCar(vehid)) then
                if (vioGetElementData(thePlayer, "autoLic") < 1) then
                    outputChatBox("Du besitzt keinen Führerschein. Pass auf, dass du nicht erwischt wirst!",255,0,0)
                end
            elseif (isBike(vehid)) then
                if (vioGetElementData(thePlayer, "bikeLic") < 1) and vehid ~= 448 then
                    outputChatBox("Du besitzt keinen Motorradführerschein. Pass auf, dass du nicht erwischt wirst!",255,0,0)
                end
